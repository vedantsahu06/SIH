...
export const StaggeredMenu = ({
  ...
  className,
  logoUrl = '/src/assets/student.svg',
  menuButtonColor = '#fff',
                ...
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      ...
                      data-index={idx + 1}
                    >
                      <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform pr-5 pb-2.5 text-2xl">
...
sition: absolute; top: 0; right: 0; width: clamp(200px, 30vw, 350px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(200px, 30vw, 350px); pointer-events: none; z-index: 5; }
